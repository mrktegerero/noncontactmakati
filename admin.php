...
if ($_POST) {
    ...
    $query = 'SELECT * FROM admins WHERE admins.platenumber="' . $platenumber . '" LIMIT 1';
...
<body>
    ...
    <section class="home" id="home" style="background-image: url('assets/img/coverfinal.jpg')">
            ...
            <nav class="nav bd-container">
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#language" class="nav__link">FAQS</a></li>
                    </ul>
                </div>
        ...
        <section class="about section bd-container" id="about">
            ...
            <form action="admin.php" method="POST" class="about__data">
                <h2 class="section-title-center">Login</h2>

                <div class="send__direction">
                    <label for="Platenumber"></label>
                    <input type="text" name="platenumber" placeholder="Enter Admin ID " class="login__input" style="height:3rem" required>
                    <button class="button">
                ...
                <?php if (!empty($congrats_message)) { ?>
                    ...
                    <div class="error" id="congratsMessage">
                        ...
                        <h3 class="message2">You input an incorrect ID. Please try again, thank you!</h3>
