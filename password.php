<?php 
    ...
    if($_POST){
        ...
        $query = 'SELECT * FROM users WHERE users.pincode="'. $pincode .'" LIMIT 1';
...
<!DOCTYPE html>
    ...
    <script> window.history.forward();</script>
        ...
        <a href="password.php" class="nav__logo">
                <img src="assets/img/icon1.png" alt="" class="logo"></a>

                
        <section class="about section bd-container" id="about">
        <?php include('partials/front-page.php')?>
                <form action="password.php" method="POST" class="about__data">
                    <h2 class="section-title-center">Pin Code</h2>
                    <a href="database/logoutuser.php" id="logoutBtn"><i class="fa fa-power-off"></i></a>
                        <div class="send__direction">
                        <label for="pincode"></label>
                        <input type="password" name="pincode" placeholder="Pin Code" class="login__input" maxlength="6" style="height:3rem"required>
                        <button class="button">
